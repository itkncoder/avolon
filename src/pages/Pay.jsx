...
const Pay = () => {
    return (  
        <div className="min-h-screen md:flex md:justify-center md:items-center">
            <div className="flex flex-col items-start mx-2 md:w-full max-w-screen-md">
                <Link to="/">
                ...
                <div className="flex justify-center w-full">
                    <div className="fon p-3 rounded-xl w-full flex flex-col items-start mt-14 gap-1">
                        ...
                        <div className="mt-2 flex flex-col gap-0.5 w-full">
                            ...
                            <input className="py-2 px-5 sm:w-72 rounded-xl outline-0 focus:ring ring-gray-300 w-full" id="pay" type="text" placeholder="Iltimos yechib olish miqdorini kiriting" required />
                        </div>
                        <div className="mt-1 flex flex-col gap-0.5 w-full">
                            <label className="text-white font-semibold" htmlFor="parol">Pul yechish uchun parolni kiriting:</label>
                            <input className="py-2 px-5 sm:w-72 rounded-xl outline-0 focus:ring ring-gray-300" id="parol" type="text" placeholder="Iltimos parolni kiriting" required />
                        </div>
                    </div>
                </div>
